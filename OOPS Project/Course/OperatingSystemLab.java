...
public class OperatingSystemLab extends JFrame implements ActionListener {
    JPanel panel1, panel2;
    JLabel label, label2, label3;
    String courseName;
    JButton button,button2;

    public OperatingSystemLab(String courseName) {
        ...
        button = new JButton("quiz has been started");
     ...
     button2.addActionListener(this);
       ...
       if(check.get(1).equals(courseName)&& comparison <=0){
            panel2.add(button);
            button.setBounds(20,60,160,30);
            button.setText("Quiz have been start");
